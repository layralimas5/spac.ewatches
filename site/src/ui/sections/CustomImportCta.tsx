...
export function CustomImportCta() {
  return (
    <section className="container-brand py-20 sm:py-24" aria-labelledby="importacao">
      <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
        <div>
          <p className="eyebrow text-gold-500">Importação personalizada</p>
          <h2 id="importacao" className="mt-3 font-display text-3xl text-cream sm:text-4xl">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <Link to="/importacao" className={buttonStyles('ghost', 'lg')}>
              Como funciona
        ...
        <ol className="space-y-px overflow-hidden rounded-xl border border-ink-700">
          {steps.map((step, index) => (
            <Reveal key={step.number} delay={index * 0.08}>
              <li className="flex gap-5 bg-ink-900 p-6">
